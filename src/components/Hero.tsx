      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center animate-fade-in">
          ...
          <div className="flex justify-center gap-6 mb-12">
            <a
              href="https://github.com/irtaza302"
              target="_blank"
            ...
            >
              <Button
                variant="outline"
                size="lg"
                className="bg-transparent border-gray-200 text-black hover:bg-gray-100 hover:text-gray-900 hover:scale-105 transition-all duration-300"
              >
            ...
            <a
              href="https://www.linkedin.com/in/irtaza-malik-15a656239/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Button
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-16">
            <Button
              size="lg"
              className="bg-gray-800 text-white px-8 py-4 text-lg font-semibold hover:bg-gray-900 hover:scale-105 transition-all duration-300"
            >
              View My Work
            </Button>
            <a
            ...
            >
              <Button
                variant="outline"
                size="lg"
                className="bg-transparent border-gray-200 text-black hover:bg-gray-100 hover:text-gray-900 px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300"
              >
                Download CV
              </Button>
            </a>
